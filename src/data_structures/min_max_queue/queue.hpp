#ifndef CUSTOMADS_SRC_DATA_STRUCTURES_MIN_MAX_QUEUE_QUEUE_HPP_
#define CUSTOMADS_SRC_DATA_STRUCTURES_MIN_MAX_QUEUE_QUEUE_HPP_
...
#endif  // CUSTOMADS_SRC_DATA_STRUCTURES_MIN_MAX_QUEUE_QUEUE_HPP_
